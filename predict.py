...
The purpose of this program is to predict the test cases by using the generated model 
in which CNN algorithm on tensorflow version 2.0.0 is adopted. 
"""

###
# USAGE
# python predict.py --model model/carsignnet.model --images sign/Test --examples examples
# python predict.py --model model/carsignnet.model --images sign/Train --examples examples
##
